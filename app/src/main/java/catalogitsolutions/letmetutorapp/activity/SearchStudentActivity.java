...
import catalogitsolutions.letmetutorapp.adapter.SearchTeacherListAdapter;
...
public class SearchStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!haveNetworkConnection()) {
            ...
            searchStudentListAdapter = new SearchStudentListAdapter(SearchStudentActivity.this, birthdaysList);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                    ...
                    Intent intent = new Intent(SearchStudentActivity.this, StudentDetailsActivity.class);
    ...
    private void getTeacherSearch(String strclass, String strsubject, String strcity, String strzone) {
        ...
        String url_teacher = AppConfig.SEARCHSTUDENT_URL +"?class="+strclass+"&subject="+strsubject+"&city="+strcity+"&zone="+strzone;
