...
public class TeacherDashboardFragment extends Fragment implements TeacherActivity.OnBackPressedListener {

    Activity context;
    View view_dashboard;
    private static final String TAG = TeacherDashboardFragment.class.getSimpleName();
