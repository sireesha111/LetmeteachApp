...
public class StudentDetailsActivity extends AppCompatActivity {
    ...
    TextView txtname, txtcode, txttypetutor, txtSexage, txtclass, txtcity, txtsubject, txtarea, txtsubarea, txtboard, txtcontactttime, txtfeesrange, txtaddress, txtmobileno, txtEmailid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idLogo.setText("Student Details");
    ...
    private void getTeacherDetails(String studentid) {
        ...
        String url_teacher = AppConfig.STUDENTDETAILS_URL +"?id="+studentid;
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, url_teacher, null, new Response.Listener<JSONObject>() {
            ...
            String strname, strcode, strttype, strsex, strsubarea, strboard, strtime, straddr, strmobileno, stremail, bitmap, strfeeshourly, strfeesmonthly, strlandmark, strzone, strcity;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    bitmap = obj.getString("st_photo");
                    strname = obj.getString("st_name");
                    strcode = obj.getString("st_code");
                    strttype = obj.getString("st_typetutor");
                    strsex = obj.getString("st_gander")+" "+obj.getString("st_age");
                    strsubarea = obj.getString("st_subarea");
                    strcity = obj.getString("st_city");
                    strzone = obj.getString("st_zone");
                    strboard = obj.getString("st_board");
                    strtime = obj.getString("st_fromtime")+" to "+obj.getString("st_totime");
                    strfeeshourly = obj.getString("st_fees_hourly");
                    strfeesmonthly = obj.getString("st_fees_monthly");
                    straddr = obj.getString("st_address");
                    strlandmark = obj.getString("st_landmark");
                    strmobileno = obj.getString("st_mobieno");
                    stremail = obj.getString("st_activateemail");
                ...
                txtcode.setText("Student Code: "+strcode);
                txttypetutor.setText("Tutor Required: "+strttype);
                txtSexage.setText(strsex);
                txtboard.setText(strboard);
