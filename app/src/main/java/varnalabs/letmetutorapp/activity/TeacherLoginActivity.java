...
public class TeacherLoginActivity extends AppCompatActivity {
        ...
        if (!haveNetworkConnection()) {
            ...
            btnLogin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!username.isEmpty() && !password.isEmpty()) {
                            ...
                            checkTeacherLogin(username, password);
                    } else {
            ...
            txtSignup.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent_te = new Intent(TeacherLoginActivity.this, TeacherRegisterActivity.class);
    ...
    private void checkTeacherLogin(final String strusername, final String strpassword) {

        pDialog.setMessage("Loading ... ");
        showDialog();
        Log.d(TAG, AppConfig.TEACHER_LOGIN_URL);
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                AppConfig.TEACHER_LOGIN_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.equalsIgnoreCase(AppConfig.LOGIN_SUCCESS)) {
                    ...
                    SharedPreferences sharedPreferences = TeacherLoginActivity.this.getSharedPreferences(AppConfig.SHARED_TEACHER_PREF_NAME, Context.MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putBoolean(AppConfig.LOGGEDIN_SHARED_PREF, true);
                    editor.putString(AppConfig.TEACHERUSER_SHARED_PREF, strusername);
                    editor.commit();
                    manager.setPreferences1(TeacherLoginActivity.this, "status", "1");
                    String status = manager.getPreferences1(TeacherLoginActivity.this, "status");
                    Log.d("status", status);
                    ...
                    ed_username.setText("");
                    ed_password.setText("");
                    Toast.makeText(TeacherLoginActivity.this, "Invalid Username or Password", Toast.LENGTH_LONG).show();
                    hideDialog();
                }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("teacher_username", strusername);
                params.put("teacher_password", strpassword);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        //this.finish();
        Intent intent = new Intent(TeacherLoginActivity.this, SelectActivity.class);
        startActivity(intent);
        finish();
    }
}
