...
$result = mysqli_query($con,"SELECT * FROM `tutors` where t_activateemail='$email'") or die(mysql_error());
...
if ($result) 
{
	...
	$actual_link = "http://192.168.0.106/sample_android_api/teacher_activate.php?email=".$email;
	$toEmail = $email;
