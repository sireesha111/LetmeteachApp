...
if (isset($_GET["id"])) {
    ...
    $result = mysqli_query($con, "SELECT *, (SELECT city_name FROM city as c WHERE c.city_id = t.t_city) as cityname, (SELECT zone_name FROM zone as z WHERE z.zone_id = t.t_zone) as zonename, (SELECT area_name FROM subarea as s WHERE s.area_id = t.t_subarea) as subareaname FROM tutors as t WHERE t_id='$id'");
